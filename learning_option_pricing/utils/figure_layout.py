"""Shared figure-layout utilities for the experiment figures of this repository.

Every experiment figure in this repository follows the same layout contract: a
formula textbox below the axes stating the plotted quantity (project
convention), legends placed outside the axes data area, and a save path that
never clips those external artists.  This module provides the three helpers
...
The experiment directories keep thin ``_figure_layout.py`` compatibility shims
that re-export these names; this module is the single source of truth.
"""
