...
NAME_CONTAINER="control_dde-firedrake_nousernamespace_uid-1001_gid-1001_hostname-mecacpt80.sif"
...
#  --bind "$PATH_CONTENT_ROOT"/docker/torchdde:"$PATH_CONTAINER_CONTENT_ROOT"/local_packages/torchdde \
# NOTE: The torchdde package mount is a temporary solution !
