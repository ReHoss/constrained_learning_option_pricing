...
PATH_PYTHON_SCRIPT="$PATH_CONTENT_ROOT"/"$RELATIVE_PATH_PYTHON_SCRIPT"
...
#S_BATCH_TIME=01:59:00
#S_BATCH_TIME=9:59:00
#S_BATCH_TIME=48:00:00
#S_BATCH_TIME=00:15:00
...
sbatch \
  ...
  --export=NAME_PROJECT="$NAME_PROJECT",PATH_PYTHON_SCRIPT="$PATH_PYTHON_SCRIPT",PATH_FOLDER_CONFIGS="$PATH_FOLDER_CONFIGS",WORKDIR="$WORKDIR",MLFLOW_TRACKING_URI="$MLFLOW_TRACKING_URI" \
