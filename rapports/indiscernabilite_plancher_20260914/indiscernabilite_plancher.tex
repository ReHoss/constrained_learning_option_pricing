...
(\code{select\_terminal\_function\_at\_strike.py}). Erreur relative $\ell^2$
...
\begin{tabular}{@{}lccc@{}}
\toprule
Construction (assemblage) & $\|\Phi_\theta-\VDO\|/\|\VDO\|$ sur $\Omega\setminus N_{0.1}$ & Delta, $\{s>0.7\}\times[0,T]$ & Gamma, $\{s>0.7\}\times[0,T-0.2]$ \\
\midrule
...
(\code{diagnostic\_scripts/predict\_corner\_layer\_floor.py}, quadrature
